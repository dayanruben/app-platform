...
class AppTemplatePresenter(@Assisted private val rootPresenter: MoleculePresenter<Unit, *>) :
  ...
  /**
   * A factory to instantiate a new [AppTemplatePresenter] instance. This implementation hides that
   * assisted injection with kotlin-inject is used. It's easier to inject this [Factory] than the
   * lambda provided by kotlin-inject.
   */
  @Inject
